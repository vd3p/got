...
-- Executor compatibility layer (Studio safe)
...
function Library:create_ui()
	...
	-- 🔍 Search (Top Right - Expandable)
	local SearchContainer = Instance.new("Frame")
	SearchContainer.Name = "SearchContainer"
	SearchContainer.Size = UDim2.new(0, 34, 0, 34)
	SearchContainer.Position = UDim2.new(1, -16, 0, 12)
	SearchContainer.AnchorPoint = Vector2.new(1, 0)
	SearchContainer.BackgroundColor3 = Color3.fromRGB(22,24,32)
	SearchContainer.BackgroundTransparency = 0.1
	SearchContainer.BorderSizePixel = 0
	SearchContainer.Parent = Handler
	...
	SearchStroke.Color = Color3.fromRGB(38,42,58)
	...
	SearchIcon.ImageColor3 = Color3.fromRGB(99, 102, 241)
	SearchIcon.BackgroundTransparency = 1
	SearchIcon.Image = "rbxassetid://117707949657765" -- أيقونة بحث
	...
	SearchPadding.PaddingLeft = UDim.new(0, 2)
	...
	local function expandSearch()
		...
		TweenService:Create(SearchContainer, TweenInfo.new(
			0.35,
			Enum.EasingStyle.Quint,
			Enum.EasingDirection.Out
			), {
		...
		TweenService:Create(SearchBox, TweenInfo.new(0.25), {
			TextTransparency = 0
		}):Play()
	...
	SearchIcon.MouseButton1Click:Connect(expandSearch)
	...
	local function FilterModules(text)
		text = string.lower(text)

		for _, data in ipairs(Library._all_modules) do
			if text == "" or string.find(data.title, text, 1, true) then
	...
	Divider.Position = UDim2.new(0.23, 0, 0.12, 0)
	Divider.Size = UDim2.new(0, 450, 0, 1)
	...
	DisplayNameLabel.Text = 'Expires: NEVER'
	...
	function self:create_tab(title: string, icon: string)
		...
		LeftSection.Size = UDim2.new(0, 243, 0, 360)
		LeftSection.Selectable = false
		LeftSection.AnchorPoint = Vector2.new(0, 0)
		LeftSection.ScrollBarImageTransparency = 1
		LeftSection.BackgroundTransparency = 1
		LeftSection.Position = UDim2.new(0.23, 0, 0.16, 0)
		...
		RightSection.Size = UDim2.new(0, 243, 0, 360)
		RightSection.Selectable = false
		RightSection.AnchorPoint = Vector2.new(0, 0)
		RightSection.ScrollBarImageTransparency = 1
		RightSection.BackgroundTransparency = 1
		RightSection.Position = UDim2.new(0.6, 0, 0.16, 0)
		...
		function TabManager:create_module(settings: any)
			...
			table.insert(Library._all_modules, {
				frame = Module,
				title = string.lower(settings.title or "")
			})
